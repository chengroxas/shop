							...
							<tr class="item-list">
								<div class="bundle  bundle-last">
									<div class="bundle-main">
										<?php if(is_array($data)): foreach($data as $key=>$goods): ?><ul class="item-content clearfix">
											<div class="pay-phone">
												<li class="td td-item">
													<div class="item-pic">
														<a href="/Home/Goods/introduce?goodspid=<?php echo ($goods['pid']); ?>" class="J_MakePoint">
															<img src="<?php echo ($goods['cover']); ?>" style="width:80px;" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="/Home/Goods/introduce?goodspid=<?php echo ($goods['pid']); ?>" class="item-title J_MakePoint" data-point="tbcart.8.11"><?php echo ($goods['goods']['itemname']); ?></a>
														</div>
													</div>
												</li>
												<li class="td td-info">
													<div class="item-props">
														<span class="sku-line">口味：<?php echo ($goods['goods']['flavor']); ?></span>
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<span>¥</span><em id="price" class="J_Price price-now"><?php echo ($goods['goods']['price']); ?></em>
														</div>
													</div>
												</li>
											</div>
											<li class="td td-amount">
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															<em tabindex="0"><?php echo ($goods['nums']); ?></em>
														</div>
													</div>
												</div>
											</li>
											<li class="td td-sum">
												<div class="td-inner">
													<span>¥</span><em tabindex="<?php echo ($goods['id']); ?>" class="J_ItemSum number"><?php echo ($goods['goods']['price']*$goods['nums']); ?></em>
												</div>
											</li>
...
<script src="/Public/js/paycart.js"></script>
