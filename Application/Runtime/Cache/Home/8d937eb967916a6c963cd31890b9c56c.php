	                  	...
	                  	<div class="theme-popover">														
							...
							<ul class="select">
								<p class="title font-normal">
									<span class="fl"><?php echo ($types['types']); ?></span>
									...
									<dl id="select1">
										<dt class="am-badge am-round">品牌</dt>	
										 ...
										 <div class="dd-conent brand">										
											<dd class="select-all selected"><a href="#" title="all">全部</a></dd>
											<?php if(is_array($brand)): foreach($brand as $key=>$brands): ?><dd><a href="javascript:void(0);" title="<?php echo ($brands['brand']); ?>"><?php echo ($brands['brand']); ?></a></dd><?php endforeach; endif; ?>
										 </div>
									</dl>
								</li>
							...
							<div class="search-content">
								<div class="sort">
									...
									<li class="big"><a id="comsort" title="comnum" href="javascript:void(0);">评价为主</a></li>
								</div>
								<div class="clear"></div>

								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									<?php if(is_array($goods)): foreach($goods as $key=>$goods): ?><li>
											<a href="/Home/Goods/introduce?pid=<?php echo ($goods['pid']); ?>&goodspid=<?php echo ($goods['id']); ?>">
										<div class="i-pic limit">
											
											<img src="<?php echo ($goods['cover']); ?>" />
											<p class="title fl"><?php echo ($goods['name']); ?></p>
											<p class="price fl">
												<b>¥</b>
												<strong><?php echo ($goods['price']); ?></strong>
											</p>
											<p class="number fl">
												销量<span><?php echo ($goods['sales']); ?></span>
											</p>
										</div>
										</a>
							...
							<div class="search-side">
								...
								<div class="side-title">
									热销商品
									<span id="<?php echo ($types['pid']); ?>" class="am-icon-refresh" style="cursor:pointer">换一换</span>
								</div>
								<div id="hot-list">
								</div>						
							</div>
			...
			<%for(var i=0;i<data.length;i++){%>
				<li>
					<div class="i-pic check">
						...
						<p class="check-title"><%=data[i].name%></p>
						<p class="price fl">
							<b>¥</b>
							<strong><%=data[i].price%></strong>
						</p>
						<p class="number fl">
							销量<span><%=data[i].sales%></span>
						</p>
					</div>
				</li>
			<%}%>			
