...
<html>
	...
	<body>
					...
					<div class="wrap-left">
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-baseinfo">
										<a class="m-pic" href="/Home/User/information">
											<?php if($_SESSION['logo']== '' ): ?><img src="/Public/images/getAvatar.do.jpg">
											<?php else: ?>
												<img src="<?php echo (session('logo')); ?>"><?php endif; ?>
										</a>
										<div class="m-info">
											<em class="s-name"><?php echo (session('user')); ?></em>
											...
											<div class="m-address">
												<a href="/Home/User/address" class="i-trigger">收货地址<i class="am-icon-angle-right" style="padding-left:5px ;"></i></a>
											</div>
										</div>
									</div>
									<div class="m-right">
							...
							<div class="m-order">
								...
								<?php if(is_array($order)): foreach($order as $key=>$orders): ?><div class="orderContentBox">
									<div class="orderContent">
										<div class="orderContentpic">
											<div class="imgBox">
												<a href="orderinfo.html"><img src="<?php echo ($orders['goods']['cover']); ?>"></a>
											</div>
										</div>
										<?php if($orders["status"] == 0): ?><div class="detailContent">
											<a href="orderinfo.html" class="delivery">待发货</a>
											<div class="orderID">
												<span class="time"><?php echo (date("Y-n-d",$orders['time'])); ?></span>
												<span class="splitBorder">|</span>
												<span class="time"><?php echo (date("H:i:s",$orders['time'])); ?></span>
											</div>
											<div class="orderID">
												<span class="num">共<?php echo ($orders['num']); ?>件商品</span>
											</div>
										</div>
										<div class="state">待发货</div>
										<?php elseif($orders["status"] == 1): ?>
										<div class="detailContent">
											<a href="orderinfo.html" class="delivery">已发货</a>
											<div class="orderID">
												<span class="time"><?php echo (date("Y-n-d",$orders['sendtime'])); ?></span>
												<span class="splitBorder">|</span>
												<span class="time"><?php echo (date("H:i:s",$orders['sendtime'])); ?></span>
											</div>
											<div class="orderID">
												<span class="num">共<?php echo ($orders['num']); ?>件商品</span>
											</div>
										...
										<div class="detailContent">
											<a href="orderinfo.html" class="delivery">待评价</a>
											<div class="orderID">
												<span class="time"><?php echo (date("Y-n-d",$orders['signtime'])); ?></span>
												<span class="splitBorder">|</span>
												<span class="time"><?php echo (date("H:i:s",$orders['signtime'])); ?></span>
											</div>
											<div class="orderID">
												<span class="num">共<?php echo ($orders['num']); ?>件商品</span>
											</div>
										...
										<div class="detailContent">
											<a href="orderinfo.html" class="delivery">交易成功</a>
											<div class="orderID">
												<span class="time"><?php echo (date("Y-n-d",$orders['signtime'])); ?></span>
												<span class="splitBorder">|</span>
												<span class="time"><?php echo (date("H:i:s",$orders['signtime'])); ?></span>
										...
										<div class="state">交易成功</div><?php endif; ?>
										<div class="price"><span class="sym">¥</span><?php echo ($orders['goods']['price']*$orders['num']); ?></span></div>
									</div>
									<a href="/Home/Goods/introduce?goodspid=<?php echo ($orders['pid']); ?>" class="btnPay">再次购买</a>
                        ...
                        <div class="am-tabs-bd">
                            ...
                            <div data-tab-panel-0 class="am-tab-panel am-active">
                        		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
									<ul class="am-slides">
									<?php if(is_array($collect)): foreach($collect as $key=>$collect): ?><li>
                                       	  <a><img class="am-thumbnail" src="<?php echo ($collect['goods']['cover']); ?>" /></a>
                                       	  <strong class="price">¥<?php echo ($collect['goods']['price']); ?></strong>
                            ...
                            <div data-tab-panel-1 class="am-tab-panel "> 
                        		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155, slideshow: false}">
									<ul class="am-slides">
                                       <?php if(is_array($foot)): foreach($foot as $key=>$foots): ?><li>
                                       	  <a><img class="am-thumbnail" src="<?php echo ($foots['goods']['cover']); ?>" /></a>
                                       	  <strong class="price">¥<?php echo ($foots['goods']['price']); ?></strong>
                                       </li><?php endforeach; endif; ?>                                  
									</ul>
								</div>                            	
                            </div>
		...
		<div class="navCir">
			...
			<li><a href="/Home/User/shopcart"><i class="am-icon-shopping-basket"></i>购物车</a></li>
			<li class="active"><a href="/Home/User/index"><i class="am-icon-user"></i>我的</a></li>
		</div>
	</body>
