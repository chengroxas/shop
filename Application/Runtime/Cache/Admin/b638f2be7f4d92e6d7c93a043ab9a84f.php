...
<body class="theme-white" data-type="login">
        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" >
                    ...
                    <div class="am-form-group">
                        <input type="text" class="tpl-form-input" id="manger" placeholder="用户名">
                    </div>
                    ...
                    <div class="am-form-group">
                        <input type="password" class="tpl-form-input" id="repwd" placeholder="再次输入密码">
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <button type="button" id="regist" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">提交</button>
	...
	<script src="/Public/Admin/js/regist.js"></script>
