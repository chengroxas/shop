...
<body data-type="widgets">
	...
	<ul class="sidebar-nav">
		...
		<li class="sidebar-nav-link">
			<a href="/Admin/Index/index" class="active">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br">
									...
									<div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <select data-am-selected="{searchBox: 1}" id="type" style="display: none;">
											  <option value="a">巧克力</option>
											  <option value="b">水果</option>
									...
									<div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <select data-am-selected="{searchBox: 1}" id="type" style="display: none;">
											  <option value="a">德芙</option>
											  <option value="b">士力架</option>
											  <option value="o">其他巧克力</option>
											</select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="goods-name" placeholder="请输入商品名称">
                                            <small></small>
                                        </div>
                                    </div>
                                    
                                    <div class="am-form-group">
                                        <label for="goods-price" class="am-u-sm-3 am-form-label">商品价格 <span class="tpl-form-line-small-title">*必填</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="goods-price" placeholder="请输入商品价格">
                                            <small></small>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label">搜索关键字 <span class="tpl-form-line-small-title">选填</span></label>
                                        <div class="am-u-sm-9">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img src="/Public/Admin/assets/img/a5.png" alt="">
                                                </div>
									 ...
									 <div class="widget-head am-cf" style="margin-bottom:20px;">
										<div class="widget-title am-fl">商品详细信息</div>
									</div>
