...
<head>
	...
	<style>
		.theme-white .tpl-table-black tbody > tr > td{padding:0px;}
	</style>
</head>
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title  am-cf">类型管理列表</div>
                            ...
                            <div class="widget-body  am-fr">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="/Admin/Goods/typesform" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span>新增/编辑</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        <thead>
                                            <tr>
												<th class=" am-text-center">排序数字</th>
												<th class=" am-text-center">一级图标</th>
                                                <th class=" am-text-center">一级类型</th>
                                                <th class=" am-text-center">查看二级类型</th>
                                        ...
                                        <tbody id="type-list">
											<?php if(is_array($types)): foreach($types as $key=>$types): ?><tr class="gradeX">
												<td class="am-text-middle am-text-center"><?php echo ($types['num']); ?></td>
												<td class="am-text-middle am-text-center">
													<img src="<?php echo ($types['icon']); ?>" class="tpl-table-line-img" alt="">
												</td>
												<td class="am-text-middle am-text-center"><?php echo ($types['types']); ?></td>
												
												<td class="am-text-middle am-text-center" >
													<div class="tpl-table-black-operation">
														<a id="<?php echo ($types['fid']); ?>" href="javascript:void(0)" title="<?php echo ($types['types']); ?>" class="view">
												...
												<td class="am-text-middle am-text-center">
													<div class="tpl-table-black-operation">
														<a href="/Admin/Goods/stypesform?fid=<?php echo ($types['fid']); ?>" title="<?php echo ($types['types']); ?>">
                                                            <i class="am-icon-plus"></i> 添加二级分类
                                                        </a>
                                                      <?php if($types["status"] == 1 ): ?><a href="javascript:void(0);" id="<?php echo ($types['fid']); ?>" class="offshelf tpl-table-black-operation-del" title="<?php echo ($types['types']); ?>">
                                                            <i class="am-icon-arrow-down"></i> 下架
                                                        </a>
                                                       <?php else: ?> 
                                                        <a href="javascript:void(0);" id="<?php echo ($types['fid']); ?>" class="onshelf" title="<?php echo ($types['types']); ?>">
