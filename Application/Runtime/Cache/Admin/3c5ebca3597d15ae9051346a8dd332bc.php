            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 编辑二级类型 <small>Orange lala</small></div>
                        ...
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" id="addform">
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">新增二级类型<span class="tpl-form-line-small-title">*必填</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input ftype"   placeholder="请输入二级类型">
                                        </div>
                                    </div>
                        ...
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-border-form tpl-form-border-br" id="editform">
                                    ...
                                    <div class="am-form-group">
                                        <label for="ftype" class="am-u-sm-3 am-form-label">二级类型 <span class="tpl-form-line-small-title">*必填</span></label>
                                        <div class="am-u-sm-3" >
											<select data-am-selected="{maxHeight: 200}" id="select-box">
											  <option value=" " selected>请选择</option>
											  <?php if(is_array($types)): foreach($types as $key=>$types): ?><option value="<?php echo ($types['fid']); ?>"><?php echo ($types['types']); ?></option><?php endforeach; endif; ?>
											</select>
                                        </div>
									</div>
...
<script src="/Public/Admin/js/stypesform.js"></script>
